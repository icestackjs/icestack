...
- You can also provide them with more sizes including but not limited to `xs`,`sm`,`md`,`lg`, like `xl`,`2xl`,`3xl`, not limited to `square`, `square`, `square`, `square`, `square`, `square`.
...
> You can use the `transformCss2Js` method exported in `@icestack/ui` to quickly transform any `css` string into this format!
