import { GetCssSchemaMethod, getSelector } from './shared'
    ...
    defaults: {
      ...
      utils: {
        [selector]: {
          ...
          [`&${getSelector('parallelogram')}`]: {
            css: {
              'mask-image':
                "url(\"data:image/svg+xml,%3csvg width='200' height='154' xmlns='http://www.w3.org/2000/svg'%3e%3cpath fill='black' d='M46.154 0H200l-46.154 153.846H0z' fill-rule='evenodd'/%3e%3c/svg%3e\")"
            }
          },
          [`&${getSelector('parallelogram-2')}`]: {
            css: {
              'mask-image':
                "url(\"data:image/svg+xml,%3csvg width='200' height='154' xmlns='http://www.w3.org/2000/svg'%3e%3cpath fill='black' d='M153.846 0H0l46.154 153.846H200z' fill-rule='evenodd'/%3e%3c/svg%3e\")"
            }
          },
          [`&${getSelector('parallelogram-3')}`]: {
            css: {
              'mask-image':
                "url(\"data:image/svg+xml,%3csvg width='154' height='201' xmlns='http://www.w3.org/2000/svg'%3e%3cpath fill='black' d='M.077 47.077v153.846l153.846-46.154V.923z' fill-rule='evenodd'/%3e%3c/svg%3e\")"
            }
          },
          [`&${getSelector('parallelogram-4')}`]: {
            css: {
              'mask-image':
                "url(\"data:image/svg+xml,%3csvg width='154' height='201' xmlns='http://www.w3.org/2000/svg'%3e%3cpath fill='black' d='M153.923 47.077v153.846L.077 154.77V.923z' fill-rule='evenodd'/%3e%3c/svg%3e\")"
            }
          },
          [`&${getSelector('pentagon')}`]: {
            css: {
              'mask-image':
          ...
          [`&${getSelector('square')}`]: {
            css: {
              'mask-image':
                "url(\"data:image/svg+xml,%3csvg width='200' height='200' xmlns='http://www.w3.org/2000/svg'%3e%3cpath fill='black' d='M0 0h200v200H0z' fill-rule='evenodd'/%3e%3c/svg%3e\")"
            }
          },
          [`&${getSelector('star')}`]: {
            css: {
