...
<aside><p>Copyright © 2023 - All right reserved by ACME Industries Ltd</p></aside>
</footer>
...
<p class="font-bold" data-svelte-h="svelte-otpbj0">
  ACME Industries Ltd.
  <br />
  Providing reliable tech since 1992
</p>
...
<nav data-svelte-h="svelte-1hjktet">
<div class="grid grid-flow-col gap-4">
  <button>
    <svg
      xmlns="http://www.w3.org/2000/svg"
...
<nav class="grid grid-flow-col gap-4" data-svelte-h="svelte-1hs0zqi">
<button class="link link-hover">About us</button>
<button class="link link-hover">Contact</button>
<button class="link link-hover">Jobs</button>
<button class="link link-hover">Press kit</button>
