...
<template>
  <div>
    ...
    <div class="stack mb-4">
      <img src="/pig.jpg" alt="Tailwind CSS example 1" class="rounded w-28" />
      <img src="/pig.jpg" alt="Tailwind CSS example 2" class="rounded w-28" />
      <img src="/pig.jpg" alt="Tailwind CSS example 3" class="rounded w-28" />
    </div>
