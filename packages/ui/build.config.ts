...
export default defineBuildConfig({
  entries: ['./src/index', './src/cli.ts', './src/defaults.ts', './src/components.ts', './src/types.ts', './src/postcss.ts', './src/config.ts', './src/shared.ts'], // './src/worker.ts'], //  './src/unocss.ts', //, './src/colors.ts'],
  rollup: {
    // 内联，相当于 nodeResolve
