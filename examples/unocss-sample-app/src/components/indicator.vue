  ...
  <div>
    ...
    <div class="avatar indicator">
      ...
      <div class="w-20 h-20 rounded-lg">
        <img alt="Tailwind CSS examples" src="/pig.jpg">
      </div>
    </div>
    ...
    <div class="indicator">
      ...
      <img alt="Tailwind CSS examples" class="rounded" src="/pig.jpg">
    </div>
    ...
    <div class="indicator">
      <span class="indicator-item indicator-middle badge badge-secondary" />
      <div class="grid w-32 h-32 bg-base-300 place-items-center">
        content
      </div>
    </div>
